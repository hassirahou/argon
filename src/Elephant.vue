                        ...
                        <div class="mt-5 py-5 text-center">
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    ...
                                    <h1 class="text-center mt-5 display1 font-weight-bold" >Elephant </h1> 

                                    <p>Le lion (Panthera leo) est une espèce de mammifères carnivores de la famille des félidés. 
                            ...
                            mais il dépasse fréquemment les 30 ans en captivité. </p>
